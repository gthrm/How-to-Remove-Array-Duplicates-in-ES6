...
Мой любимый метод - это Set, потому что это самый короткий и простой 😁
...
> **Set** is a new data object introduced in ES6. Because Set only lets you store unique values. When you pass
> in an array, it will remove any duplicate values.
